...
6 DoF. There is still a remaining bug, butI have no clue the reason. It doesnt
show untill you change a value. Even if the value ends up being changed to the
exact same value. 
